                        ...
                        <tr id="item-{{$startups->id}}">
                           ...
                           <!-- <td width="5" style="background:  #{{$startups->startup_color}}"></td> -->
                            <!-- <td width="5">{{$startups->startup_pitch}}</td>
                             ...
                             <td width="5"> <iframe width="253" height="180" src="{{$startups->startup_video}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                         </td>
                             ...
                             <td width="5">
                                ...
                                @endif
                                <td width="5">
                                @if($startups->video_confirmation == 0) <a href="javascript:void(0)" title="İmtina et"><button id="@php echo $startups->id @endphp"  class="btn btn-warning" aria-hidden="true"> İmtina et</button></a>  
                          </td>
                                @endif
                                 <td width="5">
        ...
        // });
         $(".btn-primary").click(function () {
            ...
            alertify.confirm('Təstiq prosesini təstiqləyin!', 'Bu proses geri alına bilməz',
                function () {
                    location.href = "{{url('/')}}/startup/approvevideo/" + destroy_id;
                },
                function () {

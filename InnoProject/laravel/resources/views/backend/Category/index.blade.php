                ...
                <table class="table table-striped">
                    ...
                    @foreach($data['Category'] as $Category)
                        <tr id="item-{{$Category?? ''->id}}">
                            ...
                            <td width="5"><a href="{{route('Category.edit',$Category->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                            <td width="5">
                              
                                    <a href="javascript:void(0)"><i id="@php echo $Category->id @endphp"><i  class="fa fa-trash-o " ></i></a>
